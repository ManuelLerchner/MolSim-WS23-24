...
class BoundaryConditionsType: public ::xml_schema::type
{
   ...
   * instead of making copies.
   */
  BoundaryConditionsType (::std::unique_ptr< left_type >,
                          ::std::unique_ptr< right_type >,
                          ::std::unique_ptr< bottom_type >,
                          ::std::unique_ptr< top_type >,
                          ::std::unique_ptr< back_type >,
                          ::std::unique_ptr< front_type >);
...
class BoundaryType: public ::xml_schema::type
{
   ...
   */
  void
  reflective (::std::unique_ptr< reflective_type > p);
...
#ifdef XSD_CXX11
  OutflowBoundaryType&
  operator= (const OutflowBoundaryType&) = default;
#endif
...
#ifdef XSD_CXX11
  ReflectiveBoundaryType&
  operator= (const ReflectiveBoundaryType&) = default;
#endif
...
class ThermostatType: public ::xml_schema::type
{
   ...
   * initializers for required elements and attributes.
   */
  ThermostatType (const target_temperature_type&,
                  const max_temperature_change_type&,
                  const application_interval_type&);
...
class configuration: public ::xml_schema::type
{
   ...
   * initializers for required elements and attributes.
   */
  configuration (const settings_type&,
                 const particles_type&);
   ...
   * instead of making copies.
   */
  configuration (::std::unique_ptr< settings_type >,
...
class settings: public ::xml_schema::type
{
  ...
  settings (const fps_type&,
            ...
            ::std::unique_ptr< thermostat_type >);
...
class particles: public ::xml_schema::type
{
   ...
   * @return A constant reference to the sequence container.
   */
  const single_particle_sequence&
...
configuration_ (const ::std::string& uri,
                ::xml_schema::flags f = 0,
 ...
 */
::std::unique_ptr< ::configuration >
configuration_ (::xercesc::InputSource& is,
                ::xml_schema::flags f = 0,
                const ::xml_schema::properties& p = ::xml_schema::properties ());
 ...
 */
::std::unique_ptr< ::configuration >
configuration_ (const ::xercesc::DOMDocument& d,
                ::xml_schema::flags f = 0,
                const ::xml_schema::properties& p = ::xml_schema::properties ());
 ...
 */
void
configuration_ (::xercesc::XMLFormatTarget& ft,
                const ::configuration& x, 
                const ::xml_schema::namespace_infomap& m = ::xml_schema::namespace_infomap (),
                const ::std::string& e = "UTF-8",
                ::xml_schema::flags f = 0);
...
configuration_ (const ::configuration& x, 
                const ::xml_schema::namespace_infomap& m = ::xml_schema::namespace_infomap (),
                ::xml_schema::flags f = 0);
...
void
operator<< (::xercesc::DOMElement&, const OutflowBoundaryType&);
...
void
operator<< (::xercesc::DOMElement&, const ReflectiveBoundaryType&);
