...
const SimulationInterceptorsType::DiffusionFunction_optional& SimulationInterceptorsType::
DiffusionFunction () const
{
  return this->DiffusionFunction_;
}

SimulationInterceptorsType::DiffusionFunction_optional& SimulationInterceptorsType::
DiffusionFunction ()
{
  return this->DiffusionFunction_;
}
...
void SimulationInterceptorsType::
DiffusionFunction (const DiffusionFunction_type& x)
{
  this->DiffusionFunction_.set (x);
}

void SimulationInterceptorsType::
DiffusionFunction (const DiffusionFunction_optional& x)
{
  this->DiffusionFunction_ = x;
}

void SimulationInterceptorsType::
DiffusionFunction (::std::unique_ptr< DiffusionFunction_type > x)
{
