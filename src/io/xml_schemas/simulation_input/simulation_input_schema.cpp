...
SaveFileInterceptorType::fps_type SaveFileInterceptorType::fps_default_value() { return fps_type(24LL); }

const SaveFileInterceptorType::video_length_type& SaveFileInterceptorType::video_length() const { return this->video_length_.get(); }

SaveFileInterceptorType::video_length_type& SaveFileInterceptorType::video_length() { return this->video_length_.get(); }

void SaveFileInterceptorType::video_length(const video_length_type& x) { this->video_length_.set(x); }

SaveFileInterceptorType::video_length_type SaveFileInterceptorType::video_length_default_value() { return video_length_type(30LL); }

// ThermostatInterceptorType
//

const ThermostatInterceptorType::target_temperature_optional& ThermostatInterceptorType::target_temperature() const {
    return this->target_temperature_;
}

ThermostatInterceptorType::target_temperature_optional& ThermostatInterceptorType::target_temperature() {
    return this->target_temperature_;
}

void ThermostatInterceptorType::target_temperature(const target_temperature_type& x) { this->target_temperature_.set(x); }

void ThermostatInterceptorType::target_temperature(const target_temperature_optional& x) { this->target_temperature_ = x; }
...
ThermostatInterceptorType::max_temperature_change_type ThermostatInterceptorType::max_temperature_change_default_value() {
    return max_temperature_change_type(::std::numeric_limits< ::xml_schema::double_>::infinity());
}

const ThermostatInterceptorType::application_interval_optional& ThermostatInterceptorType::application_interval() const {
    return this->application_interval_;
}

ThermostatInterceptorType::application_interval_optional& ThermostatInterceptorType::application_interval() {
    return this->application_interval_;
}

void ThermostatInterceptorType::application_interval(const application_interval_type& x) { this->application_interval_.set(x); }

void ThermostatInterceptorType::application_interval(const application_interval_optional& x) { this->application_interval_ = x; }
...
SaveFileInterceptorType::SaveFileInterceptorType(const output_format_type& output_format)
    : ::xml_schema::type(),
      output_format_(output_format, this),
      fps_(fps_default_value(), this),
      video_length_(video_length_default_value(), this) {}
...
SaveFileInterceptorType::SaveFileInterceptorType(const ::xercesc::DOMElement& e, ::xml_schema::flags f, ::xml_schema::container* c)
    : ::xml_schema::type(e, f | ::xml_schema::flags::base, c), output_format_(this), fps_(this), video_length_(this) {
    if ((f & ::xml_schema::flags::base) == 0) {
        ::xsd::cxx::xml::dom::parser<char> p(e, false, false, true);
        this->parse(p, f);
    }
...
void SaveFileInterceptorType::parse(::xsd::cxx::xml::dom::parser<char>& p, ::xml_schema::flags f) {
    ...
    if (!video_length_.present()) {
        this->video_length_.set(video_length_default_value());
    }
}
...
ThermostatInterceptorType::ThermostatInterceptorType()
    : ::xml_schema::type(),
      ...
      max_temperature_change_(max_temperature_change_default_value(), this),
...
void ThermostatInterceptorType::parse(::xsd::cxx::xml::dom::parser<char>& p, ::xml_schema::flags f) {
    ...
    if (!max_temperature_change_.present()) {
        this->max_temperature_change_.set(max_temperature_change_default_value());
    }
}
...
void operator<<(::xercesc::DOMElement& e, const SaveFileInterceptorType& i) {
    ...
    //
    {
        ::xercesc::DOMAttr& a(::xsd::cxx::xml::dom::create_attribute("video_length", e));
