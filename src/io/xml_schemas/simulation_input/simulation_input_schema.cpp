...
const SettingsType::force_sequence& SettingsType::
force () const
{
  return this->force_;
}

SettingsType::force_sequence& SettingsType::
force ()
{
  return this->force_;
}
...
ForcesType::
ForcesType (value v)
: ::xml_schema::string (_xsd_ForcesType_literals_[v])
{
}

ForcesType::
ForcesType (const char* v)
: ::xml_schema::string (v)
{
}

ForcesType::
ForcesType (const ::std::string& v)
: ::xml_schema::string (v)
{
}

ForcesType::
ForcesType (const ::xml_schema::string& v)
: ::xml_schema::string (v)
{
}

ForcesType::
ForcesType (const ForcesType& v,
            ::xml_schema::flags f,
            ::xml_schema::container* c)
: ::xml_schema::string (v, f, c)
{
...
: ::xml_schema::string (e, f, c)
{
  _xsd_ForcesType_convert ();
}

ForcesType::
ForcesType (const ::xercesc::DOMAttr& a,
            ::xml_schema::flags f,
            ::xml_schema::container* c)
: ::xml_schema::string (a, f, c)
{
...
ForcesType::value ForcesType::
_xsd_ForcesType_convert () const
{
  ::xsd::cxx::tree::enum_comparator< char > c (_xsd_ForcesType_literals_);
  const value* i (::std::lower_bound (
                    _xsd_ForcesType_indexes_,
                    _xsd_ForcesType_indexes_ + 2,
                    *this,
                    c));

  if (i == _xsd_ForcesType_indexes_ + 2 || _xsd_ForcesType_literals_[*i] != *this)
  {
    throw ::xsd::cxx::tree::unexpected_enumerator < char > (*this);
  }
...
const char* const ForcesType::
_xsd_ForcesType_literals_[2] =
{
  "LennardJones",
  "ParticleGravity"
};

const ForcesType::value ForcesType::
_xsd_ForcesType_indexes_[2] =
{
  ::ForcesType::LennardJones,
  ::ForcesType::ParticleGravity
};
...
operator<< (::xercesc::DOMElement& e, const SettingsType& i)
{
  ...
  // force
  //
  for (SettingsType::force_const_iterator
       b (i.force ().begin ()), n (i.force ().end ());
       b != n; ++b)
  {
    const SettingsType::force_type& x (*b);
...
void
operator<< (::xercesc::DOMAttr& a, const ForcesType& i)
{
  a << static_cast< const ::xml_schema::string& > (i);
}
