...
class CheckPointLoaderType: public ::xml_schema::type
{
   ...
   */
  void
  file_name (::std::unique_ptr< file_name_type > p);
...
class ForcesType: public ::xml_schema::string
{
...
#ifdef XSD_CXX11
  ForcesType&
  operator= (const ForcesType&) = default;
#endif
  ...
  operator value () const
  {
    return _xsd_ForcesType_convert ();
  }
...
void
operator<< (::xercesc::DOMAttr&, const ForcesType&);
...
void
operator<< (::xercesc::DOMElement&, const particle_source&);
