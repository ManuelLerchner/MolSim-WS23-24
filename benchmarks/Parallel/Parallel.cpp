...
void executeSimulation(int t_count, const std::vector<Particle>& particles_model) {
    ...
    if (t_count >= 1) {
        std::string serial_checkpoint_path = params_lc.output_dir_path / "MD_CHKPT_0001.chkpt";
        std::string curr_checkpoint_path = params_lc.output_dir_path / ("MD_CHKPT_000" + std::to_string(t_count) + ".chkpt");
